    ...
    <div className="absolute inset-0 flex flex-col bg-black/40 outline-none overflow-visible">
      <div className="w-full h-full flex-1 outline-none relative">
        <ResponsiveContainer width="100%" height="100%" style={{ overflow: 'visible' }}>
          <AreaChart tabIndex={-1} data={processedDowData} margin={{ top: 25, right: 20, left: 15, bottom: 15 }} style={{ overflow: 'visible' }}>
            <defs>
            ...
            <Area type="monotone" dataKey="fakeCount" stroke="#fa6ca0" strokeWidth={3} fillOpacity={1} fill="url(#colorDow)" dot={{ r: 3, fill: '#fa6ca0', strokeWidth: 0 }} activeDot={{ r: 6, fill: '#fff', stroke: '#fa6ca0', strokeWidth: 2 }} isAnimationActive={false} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
